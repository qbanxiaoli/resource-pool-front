  ...
  <div id="centreRight1">
    <div class="bg-color-black">
      <div class="d-flex pt-2 pl-2">
        ...
        <div class="d-flex">
          <span class="fs-xl text mx-2">排班表</span>
        </div>
      </div>
  ...
  data() {
    return {
      config: {
        header: ["开始", "结束", "姓名"],
        data: [
          ["0时", "6时", "<span  class='colorGrass'>马思臣</span>"],
          ["6时", "12时", "<span  class='colorGrass'>吴炜</span>"],
          ["12时", "18时", "<span  class='colorGrass'>李泽铖</span>"],
          ["118时", "24时", "<span  class='colorGrass'>李旭</span>"],
